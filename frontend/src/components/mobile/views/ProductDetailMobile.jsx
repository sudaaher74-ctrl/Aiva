...
export default function ProductDetailMobile({ product, onBack }) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-40 bg-[#050505] overflow-y-auto pb-32"
    >
      <div className="px-6 pt-14 pb-8">
        ...
        <button 
          onClick={onBack}
          className="bg-[#121212] hover:bg-gray-50 flex items-center gap-1.5 px-4 py-2 rounded-full shadow-sm text-[#ffffff] font-sans font-bold text-[11px] uppercase tracking-wider mb-8 transition-colors active:scale-95"
        >
        ...
        >
          ...
          <div className="absolute inset-0 bg-[#121212]/40 blur-3xl rounded-full scale-75" />
          <img 
            src={product.image} 
            alt={product.name} 
        ...
        >
          ...
          <h1 className="font-serif font-black text-4xl text-[#ffffff] leading-[1.05] mb-4 tracking-tight">
            {product.name}
          </h1>

          <p className="font-sans text-[#ffffff]/60 text-[13px] font-medium leading-relaxed pr-4 mb-8 text-balance">
            {product.description}
          </p>

          {/* Grid Specifications */}
          <div className="grid grid-cols-2 gap-3 mb-8">
            <div className="bg-[#121212] rounded-[20px] p-4 shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
              <p className="font-sans text-[9px] font-bold text-[#ffffff]/40 uppercase tracking-widest mb-1">BRIX</p>
              <p className="font-sans text-sm font-black text-[#ffffff]">16–18°</p>
            </div>
            <div className="bg-[#121212] rounded-[20px] p-4 shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
              <p className="font-sans text-[9px] font-bold text-[#ffffff]/40 uppercase tracking-widest mb-1">PACKING</p>
              <p className="font-sans text-sm font-black text-[#ffffff]">215 kg drum</p>
            </div>
            <div className="bg-[#121212] rounded-[20px] p-4 shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
              <p className="font-sans text-[9px] font-bold text-[#ffffff]/40 uppercase tracking-widest mb-1">SHELF LIFE</p>
              <p className="font-sans text-sm font-black text-[#ffffff]">18–24 months</p>
            </div>
            <div className="bg-[#121212] rounded-[20px] p-4 shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
              <p className="font-sans text-[9px] font-bold text-[#ffffff]/40 uppercase tracking-widest mb-1">ORIGIN</p>
              <p className="font-sans text-sm font-black text-[#ffffff]">India</p>
            </div>
          </div>
          ...
          <div className="bg-[#EAE0D3] rounded-[24px] p-5 shadow-inner mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              {['FSSAI', 'APEDA', 'BRC', 'FSSC 22000', 'ISO 22000', 'ISO 14001', 'GLOBALG.A.P.', 'Halal', 'Kosher', 'SGF', 'AQA'].map((cert, i) => (
                <div key={i} className="bg-[#121212] px-3 py-1.5 rounded-full font-sans font-bold text-[10px] text-[#ffffff] shadow-sm">
                  {cert}
                </div>
              ))}
            </div>
            ...
            <AnimatePresence mode="wait">
              {!showContactForm ? (
                ...
                <motion.div 
                  ...
                  className="bg-[#1a1a1a] rounded-[32px] p-6 shadow-xl text-white overflow-hidden"
                >
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-serif font-black text-2xl">Contact Us</h3>
                    <button onClick={() => setShowContactForm(false)} className="text-[rgba(255,255,255,0.7)] hover:text-white bg-[#121212]/10 rounded-full p-1">
                      <X size={16} strokeWidth={3} />
                    </button>
                  </div>
                  
                  {isSubmitted ? (
                    <div className="bg-[#121212]/10 rounded-2xl p-6 text-center my-4">
