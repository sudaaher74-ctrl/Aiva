...
export default function ProductDetailMobile({ product, onBack }) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-40 bg-[var(--c-black)] overflow-y-auto pb-32"
    >
      <div className="px-6 pt-14 pb-8">
        ...
        >
          ...
          <h1 className="font-serif font-black text-4xl text-[var(--c-white)] leading-[1.05] mb-4 tracking-tight">
            {product.name}
          </h1>

          <p className="font-sans text-[var(--c-white)]/60 text-[13px] font-medium leading-relaxed pr-4 mb-8 text-balance">
            {product.description}
          </p>

          {/* Grid Specifications */}
          <div className="grid grid-cols-2 gap-3 mb-8">
            <div className="bg-[var(--c-dark)] rounded-[20px] p-4 shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
              <p className="font-sans text-[9px] font-bold text-[var(--c-white)]/40 uppercase tracking-widest mb-1">BRIX</p>
              <p className="font-sans text-sm font-black text-[var(--c-white)]">16–18°</p>
            </div>
            <div className="bg-[var(--c-dark)] rounded-[20px] p-4 shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
              <p className="font-sans text-[9px] font-bold text-[var(--c-white)]/40 uppercase tracking-widest mb-1">PACKING</p>
              <p className="font-sans text-sm font-black text-[var(--c-white)]">215 kg drum</p>
            </div>
            <div className="bg-[var(--c-dark)] rounded-[20px] p-4 shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
              <p className="font-sans text-[9px] font-bold text-[var(--c-white)]/40 uppercase tracking-widest mb-1">SHELF LIFE</p>
              <p className="font-sans text-sm font-black text-[var(--c-white)]">18–24 months</p>
            </div>
            <div className="bg-[var(--c-dark)] rounded-[20px] p-4 shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
              <p className="font-sans text-[9px] font-bold text-[var(--c-white)]/40 uppercase tracking-widest mb-1">ORIGIN</p>
              <p className="font-sans text-sm font-black text-[var(--c-white)]">India</p>
            </div>
          </div>
            ...
            <AnimatePresence mode="wait">
              {!showContactForm ? (
                ...
                <motion.div 
                  ...
                  className="bg-[var(--c-dark-grey)] rounded-[32px] p-6 shadow-xl text-[var(--c-white)] overflow-hidden"
                >
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-serif font-black text-2xl">Contact Us</h3>
                    <button onClick={() => setShowContactForm(false)} className="text-[rgba(255,255,255,0.7)] hover:text-[var(--c-white)] bg-[var(--c-dark)]/10 rounded-full p-1">
