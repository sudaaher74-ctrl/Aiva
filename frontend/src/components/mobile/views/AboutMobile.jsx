...
export default function AboutMobile() {
  ...
  return (
    <div className="flex flex-col w-full pb-12">
      ...
      {/* Intro */}
      <section className="bg-[#050505] px-6 pt-12 pb-12 rounded-b-[40px] shadow-sm relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <p className="font-sans text-[10px] font-bold text-[#F4A300] uppercase tracking-widest mb-2">
            PREMIUM AGRO INGREDIENTS
          </p>
          <h1 className="font-serif font-black text-4xl text-[#ffffff] mb-4 leading-tight">
            Cultivating global quality standards
          </h1>
          <p className="font-sans text-sm text-[#ffffff]/70 leading-relaxed mb-8">
          ...
          <div className="space-y-3 mb-8">
            {points.map((point, i) => (
              <motion.div 
                ...
                className="bg-[#121212] rounded-full px-5 py-3 flex items-center gap-3 shadow-[0_4px_10px_rgba(0,0,0,0.03)]"
              >
                <div className="w-1.5 h-1.5 rounded-full bg-[linear-gradient(90deg,#ffb800,#ff8a00)] shrink-0" />
                <span className="font-sans text-[13px] font-medium text-[#ffffff]">{point}</span>
              </motion.div>
            ))}
          </div>
          
          <div className="bg-[#121212] rounded-[24px] p-6 text-center shadow-sm relative overflow-hidden">
             <p className="font-sans text-[10px] font-bold text-[#ffffff]/50 uppercase tracking-widest mb-1">
               GLOBAL REACH
             </p>
             <h3 className="font-serif font-black text-2xl text-[#ffffff] mb-6">Shipping from Navi Mumbai</h3>
             <div className="w-24 h-24 mx-auto rounded-full border border-[#F4A300]/20 flex items-center justify-center relative">
               ...
               <div className="w-12 h-12 bg-[linear-gradient(90deg,#ffb800,#ff8a00)] rounded-full flex items-center justify-center text-[#050505] font-sans font-bold text-[10px] z-10 shadow-lg">
                 INDIA
               </div>
             </div>
          </div>
      ...
      <section className="px-6 py-12">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-[#121212] rounded-[32px] p-8 shadow-sm relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#EBE0CF] rounded-bl-[100px] -z-10 opacity-50"></div>
          
          <p className="font-sans text-[10px] font-bold text-[#F4A300] uppercase tracking-widest mb-3">
            OUR STORY
          </p>
          <h2 className="font-serif font-black text-2xl text-[#ffffff] mb-6 leading-tight">
          ...
          <div className="flex items-center gap-4 mb-6 bg-[#F5EAD8] p-4 rounded-2xl">
            ...
            <div>
              <h4 className="font-sans font-bold text-[15px] text-[#ffffff]">Aishwarya Ingale</h4>
              <p className="font-sans text-[11px] font-bold text-[#ffffff]/60 uppercase tracking-wider">Founder</p>
            </div>
          </div>
          ...
          <blockquote className="border-l-2 border-[#F4A300] pl-4 font-serif text-[17px] italic text-[#ffffff]/80 font-medium leading-relaxed">
      ...
      {/* Certifications */}
      <section className="px-6 py-12">
        <h2 className="font-serif font-black text-3xl text-[#ffffff] mb-6">Certifications</h2>
        <div className="flex flex-wrap gap-2">
          {certifications.map((cert, i) => (
            <motion.div
              ...
              className="bg-[#121212] rounded-full px-4 py-2 font-sans font-bold text-xs text-[#ffffff] shadow-sm"
            >
              {cert}
            </motion.div>
          ))}
      ...
      <section className="px-6 pb-24">
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-[#1a1a1a] rounded-[32px] p-6 shadow-[0_10px_30px_rgba(0,0,0,0.5)] text-white"
        >
          ...
          <div className="space-y-3 mb-6">
            <div className="bg-[#121212]/10 rounded-2xl p-4">
          ...
          <button className="w-full bg-[linear-gradient(90deg,#ffb800,#ff8a00)] text-[#050505] py-4 rounded-full font-sans font-bold text-sm shadow-[0_4px_15px_rgba(198,113,57,0.4)] active:scale-95 transition-transform">
            Request a sample
          </button>
        </motion.div>
      </section>
