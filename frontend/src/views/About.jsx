    ...
    <div className="about-page">
        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              <Link href="#story" className="btn-gold" onClick={(e) => {
                e.preventDefault();
          ...
          <div className="founder-badge-wrapper">
            <div className="founder-badge-inner">
              ...
              <div className="founder-badge-back">
                <a href="https://www.linkedin.com/in/aishwarya-ingale1105/" target="_blank" rel="noopener noreferrer" className="founder-social"><i className="ph ph-linkedin-logo"></i></a>              </div>
            </div>
          </div>
        </div>
      ...
      <section className="partner-cta">
        <div className="partner-cta-card">
          ...
          <Link href="/contact" className="btn-gold">Contact Sales Team <i className="ph ph-arrow-right"></i></Link>
        </div>
      </section>
    </div>
  );
