      ...
      const fetchProduct = async () => {
        try {
          ...
          if (data.success) {
            ...
            // Try to supplement with static image if available
            const staticByName = getProductBySlug(backendData.slug || slug);
            if (staticByName && staticByName.image) {
              backendData.image = staticByName.image;
            }
